...
type SocialUseCase interface {
	...
	SendFriendRequest(ctx context.Context, senderId, receiverId uuid.UUID, idempotencyKey string) (*Dtos.FriendRequestResult, error)
	...
	CancelFriendRequest(ctx context.Context, senderId, requestId uuid.UUID) error
